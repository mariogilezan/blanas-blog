...
export default function DespreMine({ authors, siteConfig }) {
  ...
  return (
    <Layout {...siteConfig}>
      <NextSeo
        title={`Despre Mine | ${siteConfig?.title}`}
        description={siteConfig?.description || ''}
        canonical={`${siteConfig?.url}/despre-mine/`}
        openGraph={{
          url: `${siteConfig?.url}/despre-mine/`,
          title: `Despre Mine | ${siteConfig?.title}`,
          description: siteConfig?.description || '',
          images: [
            {
